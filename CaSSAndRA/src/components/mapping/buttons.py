...
selectperimeter = dbc.Button(id=ids.BUTTONSELECTPERIMETER, size='lg', class_name='mt-1 me-1 bi bi-cloud-download', n_clicks=0, title='use selected perimeter')
removeperimeter = dbc.Button(id=ids.BUTTONREMOVEPERIMETER, size='lg', class_name='mt-1 me-1 bi bi-cloud-minus', n_clicks=0, title='remove selected perimeter')
addnewperimeter = dbc.Button(id=ids.BUTTONADDNEWPERIMETER, size='lg', class_name='mt-1 me-1 bi-file-earmark-plus', n_clicks=0, title='add new perimeter')
copyperimeter = dbc.Button(id=ids.BUTTONCOPYPERIMETER, size='lg', class_name='mt-1 me-1 bi bi-clouds', n_clicks=0, title='copy perimeter')
